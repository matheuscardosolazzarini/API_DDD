	...
	public class Startup
	{
	   ...
	   .AddJwtBearer(option =>
	   {
		   option.TokenValidationParameters = new TokenValidationParameters
		   {
			   ...
			   IssuerSigningKey = JwtSecurityKey.Create("Secret_Key-12345678901234567890123456789012")
		   };
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
			...
			var urlCliente = "http://dominiodocliente.com.br";
			var urlCliente2 = "http://dominiodocliente.com.br";

			app.UseCors(b =>b.WithOrigins(urlCliente, urlCliente2));
